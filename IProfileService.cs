...
namespace Talent.Services.Profile.Domain.Contracts
{
    public interface IProfileService
    {
        ...
        Task<AddSkillViewModel> EditSkill(AddSkillViewModel skill, string id, string currentUserId);
        ...
        Task<AddLanguageViewModel> EditLanguage(AddLanguageViewModel language, string id, string currentUserId);

        Task<ExperienceViewModel> AddNewExperience(ExperienceViewModel skill, string currentUserId);

        Task<bool> DeleteExperience(string id, string currentUserId);

        Task<ExperienceViewModel> EditExperience(ExperienceViewModel experience, string id, string currentUserId);
